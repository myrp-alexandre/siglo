...
{
    public class Sector : Entity, IValidatable
    {
        public Sector() { }

        public Sector(NameOrDescription name, long createdByUser, CompanyAndBranchOffice companyId, string machineNameOrIP)
        {
            Name = name;
